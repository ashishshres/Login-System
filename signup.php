...
<body class="bg-zinc-900 text-white flex flex-col justify-center items-center h-full w-full">
    ...
    <?php
    if ($showAlert) {
        echo ' <div class="transition duration-300 ease-in-out toast-signup space-y-3 fixed top-20 right-0 mx-2">
    ...
    <div class="w-full flex justify-center items-center flex-col gap-4 p-4 ">
        ...
        <form action="./signup.php" method="post" class="w-full max-w-[300px] mx-auto">
            <div class="mb-5">
            ...
            <div class="flex items-start mb-5">
                <div class="flex items-center h-5">
                    <input id="show" type="checkbox" value="" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800" required />
                </div>
                <label for="show" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Show password</label>
            </div>
            <button type="submit" name="signup" class="signup text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign up</button>
        </form>
    </div>
